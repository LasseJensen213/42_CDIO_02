...
public class Fields_StringBank {
	...
	// Default message when arriving at start position

	private static String startPosMsg = "You've arrived at the start";
	///for Wizard
	...
	private static String[] fieldNames = {start,tower,crater,palaceGates,coldDesert,walledCity,
	...
	public static String getBoardMessage(int fieldNumber, int characterNumber)
	{
		...
		{
			return BoardMessages[fieldNumber-1][characterNumber][randomvalue];
		}
	}
